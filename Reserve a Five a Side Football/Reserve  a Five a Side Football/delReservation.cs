    ...
    public partial class delReservation : Form
    {
      private readonly Reserve_a_Five_a_SideEntities context1;
        ...
        private void del_Reservation_Load(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.Rows.Add(item.FullName, item.Reservation_Date.Value.Date.ToString("yyyy-MM-dd"), item.Reservation_Time.ToString(), item.Payment,item.Reservation_Statues);
            }
        }
    }
